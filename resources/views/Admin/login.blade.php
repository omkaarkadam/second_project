  ...
  <div class="container">
    <div class="row justify-content-center mt-4">
      <div class="col-md-6">
        ...
        <h3 class="text-center mb-4"><b>Admin Login</b></h3>
        <form class="border border-1 rounded p-4">
          <div class="mb-3">
            <label for="loginUsername" class="form-label">Email</label>
            <input type="email" class="form-control rounded-pill" placeholder="Enter Email" id="loginUsername" required>
          </div>
          <div class="mb-3">
            <label for="loginPassword" class="form-label">Password</label>
            <div class="input-group">
              <input type="password" class="form-control rounded-pill" placeholder="Enter Password" id="loginPassword" required>
          ...
          <p class="text-center mt-4">Don't have an account? <a href="reg.html" class="text-decoration-none">Sign up</a></p>
